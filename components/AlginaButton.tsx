...
export default function StatusButton() {
  ...
  return (
    <button
      ...
      disabled={!isEnabled}
      className="group relative h-10 min-w-40 overflow-hidden rounded-md bg-gradient-to-r from-[#c471f5] via-[#fa71cd] to-[#fda085] px-6 text-sm font-semibold text-white transition-colors duration-300 hover:bg-teal-600"
    >
