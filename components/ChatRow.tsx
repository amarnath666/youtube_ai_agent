...
function ChatRow({
  ...
  return (
    <div className="group rounded-xl border border-gray-200/30 backdrop-blur-sm hover:bg-white/80 transition-all duration-200 cursor-pointer shadow-sm hover:shadow-md"
        onClick={handleClick}
    >
        <div className="p-4">
