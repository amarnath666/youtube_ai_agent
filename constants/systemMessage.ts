const SYSTEM_MESSAGE = `You are an AI assistant that uses tools to help answer questions. You haval tools that can help you find information and perform tasks.e access to sever
